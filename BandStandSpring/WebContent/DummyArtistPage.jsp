...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<form class action="leaveDummyPage.do" method="GET">
			<input type="hidden" name="id"
					value="${artist.id}">
			<button style="margin-top: 10px;" class="btn btn-default"
					type="submit">Go back to the band portal</button>
					</form>
	...
	${comment.user.firstName}
		...
		type="textarea" name="year" value="2010"> <input type="submit"> -->
						...
						<li><input class="btn btn-warning" 
				...
				<div class="jumbotron">
					...
					<ul class="list-inline">
						...
						<li><input class="btn btn-default" name="submit rating"></li>
						</form>
						<li>
					</ul>
					...
					<form>
						...
						<p style="padding-top: 10px;">
							<input class="btn btn-default" name="submit comment">
						</p>
					</form>
					<p>
					</ul>
